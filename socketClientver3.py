...
#probebly need for incoming massage
def sender(port,data):
    buff_size = 1024
    with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as sock:
        ...
        print("udp data sended to port:", port)
